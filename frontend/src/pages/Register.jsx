...
import { UserPlus, User, Mail, Lock, Loader2, ArrowRight, Sparkles } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <div className={`text-center mb-8 transition-all duration-500 delay-150 ${
            ...
            <p className="text-gray-500 text-sm">Join TechPulse and start writing</p>
          </div>
          ...
          <div className={`mb-4 transition-all duration-500 delay-200 ${
            ...
            <div className={`relative flex items-center border-2 rounded-xl transition-all duration-200 ${
              ...
              <User size={18} className={`ml-4 transition-colors duration-200 ${
          ...
          {/* Email field */}
          <div className={`mb-4 transition-all duration-500 delay-[250ms] ${
            mounted ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
          }`}>
            <div className={`relative flex items-center border-2 rounded-xl transition-all duration-200 ${
              focusedField === "email"
